...
describe UserSessionsController, "handling GET /user_sessions" do
  ...
  it "should find all user_sessions" do
    UserSession.should_receive(:find).with(:all).and_return([@user_session])
    do_get
  end
...
describe UserSessionsController, "handling GET /user_sessions.xml" do

  before do
    @user_session = mock_model(UserSession, :to_xml => "XML")
    UserSession.stub!(:find).and_return(@user_session)
  end
  ...
  it "should render the found user_session as xml" do
    @user_session.should_receive(:to_xml).and_return("XML")
    do_get
...
describe UserSessionsController, "handling GET /user_sessions/1" do
  ...
  it "should find the user_session requested" do
    UserSession.should_receive(:find).with("1").and_return(@user_session)
    do_get
  end
...
describe UserSessionsController, "handling GET /user_sessions/1.xml" do
